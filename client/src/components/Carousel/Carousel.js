            ...
            <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active ">
                        <img className="d-block w-100" src={require("../../Assets/home-01.png")} alt="First slide" />
                    </div>
                    <div className="carousel-item">
                        <img className="d-block w-100" src={require("../../Assets/home-02.png")} alt="Second slide" />
                    </div>
                    <div className="carousel-item">
                        <img className="d-block w-100" src={require("../../Assets/home-03.png")} alt="Third slide" />
                    </div>
                </div>
